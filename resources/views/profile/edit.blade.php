...
@section('content')
    ...
    <div class="py-5" style="background-color: #FEF3F0; min-height: 70vh;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden">
                        <div class="card-header d-flex align-items-center text-white p-4"
                        ...
                        <div class="card-body p-4 bg-white">
                            {{-- PERINGATAN: File partial ini kemungkinan masih menggunakan TAILWIND --}}
                    ...
                    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                        <div class="card-header d-flex align-items-center bg-danger text-white p-4">
