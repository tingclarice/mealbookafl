                    ...
                    <div class="card-body p-0">
                        <div class="row g-0" style="min-height: 400px;">
                            ...
                            <div class="col-md-3 border-end bg-light">
                                <div class="list-group list-group-flush pt-2 settings-menu" id="settings-tab"
                                    role="tablist">

                                    <a class="list-group-item list-group-item-action active" id="v-pills-profile-tab"
                                    ...
                                    <a class="list-group-item list-group-item-action" id="v-pills-security-tab"
                                        data-bs-toggle="pill" href="#v-pills-security" role="tab"
                                    ...
                                    <a class="list-group-item list-group-item-action" id="v-pills-danger-tab"
                                        data-bs-toggle="pill" href="#v-pills-danger" role="tab"
                                        aria-controls="v-pills-danger" aria-selected="false">
                                ...
                                <div class="tab-content p-4 p-md-5" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="v-pills-seller" role="tabpanel">
                                        ...
                                        @if ($pendingOwnedShop && $pendingOwnedShop->status == "PENDING")
                                            {{-- PENDING STATE UI --}}
                                            <div class="text-center p-5 rounded-4 mt-3"
                                                style="background-color: #fff9f7; border: 1px dashed #F97352;">

                                                {{-- Icon (Sandwich/Clock/Shop Icon) --}}
                                                <div class="mb-3">
                                                    <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#F97352"
                                                ...
                                                <p class="text-muted mb-4" style="max-width: 400px; margin: 0 auto;">
                                                    We have received your request to open
                                                    <strong>{{ $pendingOwnedShop->name }}</strong>.
                                                    <br>
                                                    Your request is currently under review. We will let you know as soon as your
                                                    shop is approved!
                                                </p>
                                        ...
                                        @elseif ($pendingOwnedShop && $pendingOwnedShop->status == "REJECTED")
                                            <div class="text-center p-5 rounded-4 mt-3"
                                                style="background-color: #fff5f5; border: 1px dashed #dc3545;">
                                                ...
                                                <p class="text-muted mb-4" style="max-width: 450px; margin: 0 auto;">
                                                    Unfortunately, your request to open
                                                    <strong>{{ $pendingOwnedShop->name }}</strong> was not approved.
                                                    <br>
                                                    Please contact the administrator if you believe this is a mistake or to
                                                    discuss further steps.
                                                </p>

                                                <form action="{{ route('shops.cancel') }}" method="POST" class="d-inline"
                                                    onsubmit="return confirm('Are you sure you want to cancel/clear this request? This will allow you to submit a new application.');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                        ...
                                        @unless(Auth::user()->isOwnerOrStaff())
                                            ...
                                            <form action="{{ route('shops.request') }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf

                                                {{-- Shop Image --}}
                                                <div class="mb-3">
                                                    <label class="form-label fw-semibold small text-muted text-uppercase">Shop
                                                        Image</label>
                                                ...
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label fw-semibold small text-muted text-uppercase">Address</label>
                                                ...
                                                <div class="mb-3">
                                                    <label
                                                        class="form-label fw-semibold small text-muted text-uppercase">Phone</label>
                                                ...
                                                <div class="mb-4">
                                                    <label
                                                        class="form-label fw-semibold small text-muted text-uppercase">Description</label>
                                                    <textarea class="form-control" rows="3" name="description"
                                                        placeholder="Tell us about your shop..." required></textarea>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-danger" role="tabpanel"
                                        aria-labelledby="v-pills-danger-tab">
