                    ...
                    <div class="card shadow-sm h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-grid gap-2 d-sm-flex">
                                <button type="button" class="btn btn-warning flex-sm-fill" data-bs-toggle="modal"
                                    data-bs-target="#editMenuModal" data-meal-id="{{ $meal->id }}"
                                    data-meal-name="{{ $meal->name }}" data-meal-description="{{ $meal->description }}"
                                    data-meal-price="{{ $meal->price }}" data-meal-category="{{ $meal->category }}"
                                    data-meal-image="{{ $meal->image_url }}"
                                    data-meal-available="{{ $meal->isAvailable ? '1' : '0' }}">
                                    Edit
                                </button>
                                <form action="{{ route('meals.destroy', $meal->id) }}" method="POST" class="flex-sm-fill"
                            ...
                            <button type="button" class="btn btn-dark w-100 mt-2 btn-manage-options" data-bs-toggle="modal"
                                data-bs-target="#customizationModal" data-meal-id="{{ $meal->id }}"
                ...
                <form action="{{ route('meals.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="add-description" rows="3" class="form-control"
                                placeholder="e.g., Nasi goreng spesial dengan telur..." required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="add-price" class="form-label">Price (Rp)</label>
                            <input type="number" name="price" id="add-price" step="0.01" class="form-control"
                        ...
                        <div class="mb-3">
                            <label for="add-images" class="form-label">Images (Multiple)</label>
                            <input type="file" name="images[]" id="add-images" class="form-control" accept="image/*"
                                multiple>
                            <small class="text-muted">You can select multiple images. The first image will be set as
                                primary.</small>
                ...
                <form id="editMealForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="edit-description" rows="3" class="form-control"
                                required></textarea>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="edit-current-images" class="mb-3"></div>

                            <label for="edit-images" class="form-label">Add More Images (optional)</label>
                            <input type="file" name="images[]" id="edit-images" class="form-control" accept="image/*"
                                multiple>
                            <small class="text-muted">Select additional images to add to this meal</small>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="addGroupForm" class="mb-4 p-3 bg-light rounded border">
                        ...
                        <div class="form-text mt-2">Create a group (like "Size") before adding options (like "Small",
                            "Medium").</div>
                    </form>
